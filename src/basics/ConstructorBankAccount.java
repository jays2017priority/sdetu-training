...
public class ConstructorBankAccount {
	...
	//This is also an example of polymorphism, same method name, different parameter
	ConstructorBankAccount(String accountType){
		System.out.println("New Account" + accountType);
	}
	
	//this is an example of polymorphism-same method name, different parameter
	ConstructorBankAccount(String accountType, double initDeposit){
		System.out.println("New Account" + accountType);
